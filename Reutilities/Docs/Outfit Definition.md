...
- ![*(compound)*](/Revaried/Docs/Tags/compound_tag.png) The root object.
  - ![*(compound)*](/Revaried/Docs/Tags/compound_tag.png) **head**: *(optional)* The head outfit slot. Used when getting a texture for the entity's head.
    - ![*(string)*](/Revaried/Docs/Tags/string_tag.png) **texture**: A resource location for the texture used by this outfit slot. Omits the `textures/` prefix and `.png` suffix.
    - ![*(string)*](/Revaried/Docs/Tags/string_tag.png) **emissive_texture**: *(optional)* A resource location for the emissive texture used by this outfit slot. Omits the `textures/` prefix and `.png` suffix.
    - ![*(string)*](/Revaried/Docs/Tags/string_tag.png) **overlay_texture**: *(optional)* A resource location for the overlay texture used by this outfit slot. This layer is not colored if either the item is colored or this slot has a defined ![*(int or string)*](/Revaried/Docs/Tags/integer_tag.png)![](/Revaried/Docs/Tags/string_tag.png) **color** field. Omits the `textures/` prefix and `.png` suffix.
    - ![*(boolean)*](/Revaried/Docs/Tags/boolean_tag.png) **hides_skin_layers**: *(optional)* A boolean controlling whether this slot hides the skin layers related to this slot.
...
| Version                                                        | Changes                                                                                                                                                                                         |
| -------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [1.9.0.5](/Back%20Math/Changelogs/Changelog%201.9.0.5-beta.md) | <li> Added outfit definitions to data packs. </li> <li> Currently, the ![*(string)*](/Revaried/Docs/Tags/string_tag.png) **emissive_texture** field doesn't work because I didn't implement it. |
| [1.9.0.6](/Back%20Math/Changelogs/Changelog%201.9.0.6-beta.md) | <li> Added the ![*(int)*](/Revaried/Docs/Tags/integer_tag.png) **color** field. </li> <li> The ![*(string)*](/Revaried/Docs/Tags/string_tag.png) **emissive_texture** field now works. </li>    |
...
| 1.4.0   | <li>The ![*(int)*](/Revaried/Docs/Tags/integer_tag.png) **color** field now accepts hexadecimal integers (prefixed with "#").</li> <li>Added the ![*(string)*](/Revaried/Docs/Tags/string_tag.png) **overlay_texture** field.</li> <li>*OutfitDefinition* and *OutfitSlot* now use use builder for making new instances.</li> |
| 1.5.0   | The ![*(int)*](/Revaried/Docs/Tags/integer_tag.png) **color** field is now capped between **0** and **16777215** (`#ffffff`).                                                                                                                                                                                                 |
