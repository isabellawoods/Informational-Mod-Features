...
- <img src=Tags/compound_tag.png> The behavior tag.
  - <img src=Tags/compound_tag.png> **item**: The item used to clear all effects. Defaults to a milk bucket.
    > **Tags common to all items saved by *Revaried*:**
    > - <img src=Tags/string_tag.png> **id**: The id of the item.
    > - <img src=Tags/integer_tag.png> **count**: How many items there are in this stack. Effectively capped at 127 due to the default count tag being a <img src=Tags/byte_tag.png> byte.
    > - <img src=Tags/compound_tag.png> **tags**: The tags this item stack has.
...
- <img src=Tags/compound_tag.png> The behavior tag.
  - <img src=Tags/compound_tag.png> **item**: The item for the entity to eat.
    > **Tags common to all items saved by *Revaried*:**
    > - <img src=Tags/string_tag.png> **id**: The id of the item.
    > - <img src=Tags/integer_tag.png> **count**: How many items there are in this stack. Effectively capped at 127 due to the default count tag being a <img src=Tags/byte_tag.png> byte.
    > - <img src=Tags/compound_tag.png> **tags**: The tags this item stack has.
...
- <img src=Tags/compound_tag.png> The behavior tag.
  - <img src=Tags/float_tag.png> **radius**: The radius of the explosion. Ranges from `0` to `128`. Maximum is defined by the `explosion_radius_upper_limit` setting.
  ...
  - <img src=Tags/list_tag.png> **position**: An array of three doubles of where to cause this explosion.
...
- <img src=Tags/compound_tag.png> The behavior tag.
  ...
  - <img src=Tags/string_tag.png> **source**: What category to use when playing this sound. Can be one of `master`, `music`, `record`, `weather`, `block`, `hostile`, `neutral`, `player`, `ambient` or `voice`.
  ...
  - <img src=Tags/list_tag.png> **position**: An array of three doubles of where to play this sound.
  ...
  - <img src=Tags/float_tag.png> **pitch**: The pitch to play this sound with. Ranges from `0` to `2`. Maximum is defined by the `sound_pitch_upper_limit` setting.
  - <img src=Tags/boolean_tag.png> **send_sound_packet**: Whether this sound should send a *SPlaySoundPacket* to the player instead of playing it through the server.
...
- <img src=Tags/compound_tag.png> The behavior tag.
  - <img src=Tags/boolean_tag.png> **teleport_randomly**: Whether to teleport to a random position within a radius or not.
  - <img src=Tags/float_tag.png> **diameter**: The diameter of where to take a random position from. Only used if `teleport_randomly` is true. Defaults to `8`.
  - <img src=Tags/list_tag.png> **position**: An array of three doubles indicating where to teleport. Only use if `teleport_randomly` is false. Defaults to the entity's current position.

### References
[^1]: [RV-7](https://github.com/isabellawoods/Revaried/issues/7) – Explode behavior effect clouds always get effects from `behavior.effects[]`, even when in multi-behaviors.
[^2]: [RV-9](https://github.com/isabellawoods/Revaried/issues/9) – Apply Effects behavior tooltip always gets effects from `behavior.effects[]`, even when in multi-behaviors.