...
| [1.8.0.7](/Revaried/Changelogs/1.16.5%20-%201.8.0.7/Changelog%201.8.0.7.md)              | Bowl types using vanilla wood types are now under the `minecraft` namespace instead of `variants`.                                                                                                                                                    |
...
| [8.0.11](/Revaried/Changelogs/Changelog%208.0.11.md)                                     | The "duplicate texture id" message no longer appears if the conflict is with the same bowl type.                                                                                                                                                      |
