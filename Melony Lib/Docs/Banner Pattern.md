...
- ![*(compound)*](/Revaried/Docs/Tags/compound_tag.png) The root object.
  - ![*(string)*](/Revaried/Docs/Tags/string_tag.png) **asset_id**: The resource location and enum name of this banner pattern. Should match the filename and namespace of this pattern.
  - ![*(string)*](/Revaried/Docs/Tags/string_tag.png) **hash_name**: A three letter abbreviation of this pattern's ![](/Revaried/Docs/Tags/string_tag.png) **asset_id**.
  - ![*(boolean)*](/Revaried/Docs/Tags/boolean_tag.png) **has_pattern_item**: Whether this banner pattern has an associated banner pattern item. Defaults to `false`.
