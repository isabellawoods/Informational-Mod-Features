...
> [!NOTE]
> This feature was present in older versions of *Stancements*, but has since been removed.
> 
> **Last Updated**: 31-05-26 (0.4.2 - 1.21.1 | 0.4.1.1 - 26.1.2)

`recorded_song_styles.json` was a **jukebox song data map** defining a color and a label for when a song is recorded/copied. If not defined, the item would have a randomized color and label.

The data map file was located at `data/stancements/data_maps/jukebox_song/recorded_song_styles.json`.

## JSON format
Recorded song styles were defined using the following format:
...
| [0.4.1](/Stancements/Changelogs/Changelog%200.4.1%20(1.21).md)   | The ![*(int)*](/Revaried/Docs/Tags/integer_tag.png) **color** field now accepts hexadecimal integers (prefixed with "#").                                                                                                                                                                                                                                                                                        |
...
| [0.4.2](/Stancements/Changelogs/Changelog%200.4.2.md)            | Removed this data map, and replaced it with the [`recorded_disc_style`](/Stancements/Docs/Recorded%20Disc%20Style.md) registry. This is because the ![*(compound)*](/Revaried/Docs/Tags/compound_tag.png) **neoforge:conditions** field used by the RMS data pack cannot be used on individual entries of the map.                                                                                               |

## Issues
Issues relating to "Recorded song styles" will no longer be maintained on [*Stancements*' issue tracker](https://github.com/isabellawoods/Stancements/issues), as this feature has been removed.
...
| **Stancements**   | ![](/Textures/navbox/pot_plantables.png) [Pot Plantables](/Stancements/Docs/Pot%20Plantables.md)  ▪ ![](/Textures/navbox/recorded_song_styles.png) **Recorded Song Styles** ▪ ![](/Textures/navbox/recorded_disc_style.png) [Recorded Disc Style](/Stancements/Docs/Recorded%20Disc%20Style.md)                                                                                                                                                                                                                                                                                                                   |
