...
- Added crafting table cloths
  ...
  - These block access to the workstation below them.
  - Crafted using two carpets of the same color in a horizontal line.
...
- Shelves no longer attach themselves to nearby blocks like ladders. They are now directional like other blocks.
